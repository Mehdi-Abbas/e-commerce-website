...
<div class="container">
  ...
  <form action="" method="post" name="slider_form">
    ...
    <div class="form-group">
      ...
      <textarea type="text" class="form-control" id="description" placeholder="Enter description" name="description" rows="10"></textarea>
    </div>
    <div class="form-group">
...
if(isset($_POST["insert"])){
  ...
  mysqli_query($conn,"INSERT INTO `tbl_4` (`image`, `title`, `description`, `status`, `date`) VALUES ( '$_POST[image]', '$_POST[title]', '$_POST[description]', '$_POST[status]',  '$_POST[date]');");
