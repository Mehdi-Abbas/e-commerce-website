...
$res=mysqli_query($conn,"select * from tbl_2 where id=$id");
...
if(isset($_POST["update"])){
  ...
  mysqli_query($conn,"update tbl_2 set title='$_POST[title]',description='$_POST[description]',image='$_POST[image]' , status='$_POST[status]' where id=$id ;");
