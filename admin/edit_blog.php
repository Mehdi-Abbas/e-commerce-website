...
$res=mysqli_query($conn,"select * from tbl_4 where id=$id");
...
<div class="container">
  ...
  <form action="" method="post" name="slider_form">
    ...
    <div class="form-group">
      ...
      <input type="date" class="form-control" id="date" placeholder="Enter 1(Active) or 0(Inactive)" name="date" value="<?php echo $date; ?>">
    </div>
...
if(isset($_POST["update"])){
  ...
  mysqli_query($conn,"update tbl_4 set title='$_POST[title]',description='$_POST[description]',image='$_POST[image]' , status='$_POST[status]', date='$_POST[date]' where id=$id ;");
